...
class Operaciones
{
    ...
    //lo has metido para ver lo de la tabla otroexamen
        public function mostrarInfo()
        {
            $producto = new Producto();
            // Llamas a la función mostrar y guardas el resultado en $resultado
            $resultado = $producto->mostrar();
            
            // Puedes hacer algo con $resultado, por ejemplo, imprimirlo o retornarlo
            return $resultado;
        }
