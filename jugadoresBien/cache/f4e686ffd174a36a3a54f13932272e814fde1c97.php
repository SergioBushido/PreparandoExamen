...
<!--crea el formulario-->
    <form name="crear" action="crearJugador.php" method="post">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
                ...
                <?php else: ?>
                    <input type="text" value="<?php echo e($code); ?>" maxlength="13" class="form-control" name="barcode" readonly>
                <?php endif; ?>
            </div>
        </div>
        <?php if(!isset($code)): ?>
    ...
    <?php if(isset($error)): ?><!--Si existe un error va a mostrar un mensaje en fondo rojo-->
