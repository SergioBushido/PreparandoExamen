    ...
    <form action="actualizar.php" method="POST" class="needs-validation" novalidate>
        <?php if($actualiza): ?>
            ...
            <div class="form-group">
                ...
                <input type="text" name="nom" class="form-control" value="<?php echo e($actualiza->nombre); ?>" required>
                <div class="invalid-feedback">Campo obligatorio</div>
            </div>

            <div class="form-group">
                <label for="des">Descripción:</label>
                <textarea name="des" class="form-control" required><?php echo e($actualiza->descripción); ?></textarea>
                <div class="invalid-feedback">Campo obligatorio</div>
            </div>

            <div class="form-group">
                <label for="pvp">PVP:</label>
                <input type="number" name="pvp" class="form-control" value="<?php echo e($actualiza->pvp); ?>" required>
                <div class="invalid-feedback">Campo obligatorio</div>
            </div>
